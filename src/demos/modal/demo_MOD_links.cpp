...
constexpr bool USE_STATIC_CORRECTION = true;//necessary for the proper recovery of reaction forces of internal links
...
void MakeAndRunDemo_Links(bool do_modal_reduction, ChMatrixDynamic<>& res) {
    ...
    if (do_modal_reduction) {
        ...
        ChModalSolverUndamped<ChUnsymGenEigenvalueSolverKrylovSchur> modal_solver(13, 1e-4, true, false, eigen_solver);
        ...
        modal_assembly->DoModalReduction(modal_solver, damping_beam);
